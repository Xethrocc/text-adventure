...
for name in thefog pure-if fantasy cyberpunk space-opera detective horror factions trade encounters survival stealth combat-off combat-narrative combat-classic party starship; do
    case "$name" in
        thefog)             src=examples/thefog.yaml ;;
        factions|trade|encounters|survival|stealth|combat-off|combat-narrative|combat-classic|party|starship)     src="examples/modules/$name.yaml" ;;
