...
for name in thefog pure-if fantasy cyberpunk space-opera detective horror factions trade encounters; do
    case "$name" in
        thefog)             src=examples/thefog.yaml ;;
        factions|trade|encounters)     src="examples/modules/$name.yaml" ;;
