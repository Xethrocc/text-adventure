...
- **GameState**: Complete game state including rooms, player, and inventory
- **Room**: Individual locations with descriptions, items, and exits
...
initMyGame = GameState
    { rooms = Map.fromList
        [ ("start", Room
            ...
            , roomItems = [Item "item_name" "Item description." ["keyword1", "keyword2"]]
            , roomConnections = Map.fromList [(North, "room2")]
            , roomVisited = True
            })
        , ("room2", Room
